...
if __name__ == "__main__":
    ...
    parser.add_argument("--config", type=str, default="checkpoint/Base/ScgMamba-B-M-GCN/config.yaml", help="Path to the config file.")
    parser.add_argument('-e', '--evaluate', default='checkpoint/Base/ScgMamba-B-M-GCN/best_epoch.bin', type=str, metavar='FILENAME', help='checkpoint to evaluate (file name)')
